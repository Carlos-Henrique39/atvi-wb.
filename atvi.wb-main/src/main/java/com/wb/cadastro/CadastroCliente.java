...
public class CadastroCliente extends Cadastro {
	...
	public void cadastrar() {
		...
		System.out.println("Por favor insira o nome social do cliente:");
		String nomeSocial = entrada.receberTexto();
		
		String genero = "";
		boolean execucaoGenero = true;
		while(execucaoGenero) {
			System.out.println("Por favor insira o gênero do cliente");
		...
		System.out.println("Por favor insira o número do cpf:");
		String valor1 = entrada.receberTexto();
		System.out.println("Por favor insira a data de emissão do cpf, no padrão dd/mm/yyyy:");
		...
		while (outroRg.equals("sim")) {
			System.out.println("Por favor insira o número do RG:");
			String valor2 = entrada.receberTexto();
			System.out.println("Por favor insira a data de emissão do rg, no padrão dd/mm/yyyy:");
		...
		while (outroTel.equals("sim")) {
			...
			System.out.println("Por favor insira seu telefone para contato:");
