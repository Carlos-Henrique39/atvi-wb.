	...
	public void executar() {
		...
		while ( edit ) {
			...
			case 1:									
				...
				System.out.println("\nQual dos elementos você deseja editar");
				System.out.println("1 - Nome");
				System.out.println("2 - CPF");
				System.out.println("3 - RG");
				System.out.println("4 - Telefone");
				System.out.println("0 - Voltar");
				System.out.println("\nInsira o número do cliente que você deseja editar");
				...
				switch ( editarCli ) {
				case 1:
					System.out.println("Por favor coloque o novo nome do cliente:");
					String nome = entrada.receberTexto();
					this.empresa.getClientes().get(numCliente).nome = nome;
					
					System.out.println("Por favor coloque o novo nome social do cliente:");
				...
				case 2:
					System.out.println("Por favor coloque o CPF do cliente:");
					String cpf = entrada.receberTexto();
					this.empresa.getClientes().get(numCliente).getCpf().setValor(cpf);
					
					System.out.println("Por favor coloque a data de emissão do CPF:");
				...
				case 3:
					...
					while (true) {
						...
						System.out.println("Por favor coloque o RG do cliente:");
						String valor = entrada.receberTexto();
						this.empresa.getClientes().get(numCliente).getRgs().get(numRg).setValor(valor);
						
						System.out.println("Por favor coloque a data de emissão do RG:");
